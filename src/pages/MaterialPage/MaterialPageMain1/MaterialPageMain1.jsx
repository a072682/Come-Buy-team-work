...
function MaterialPageMain1({ handleOpenMaterialModal }){
    ...
    return(
        <>
            <div className="MaterialPageMain1">
                <div className="MaterialPageMain1-bg">
                    <div className="container">
                        <div className="row">
                            <div className="col-12 col-lg-10 mx-auto">
                                <div className='MaterialPageMain1-content'>
                                    
                                    <div className="MaterialPageMain1-title">
                                        <h3 className="title-set">FDM</h3>
                                    </div>
