...
function MaterialPageMain2({handleOpenMaterialModal}){
    ...
    return(
        <>
            <div className="MaterialPageMain2">
                <div className="MaterialPageMain2-bg">
                    <div className="container">
                        <div className="row">
                            <div className="col-12 col-lg-10 mx-auto">
                                <div className='MaterialPageMain2-content'>
                                    
                                    <div className="MaterialPageMain2-title">
                                        <h3 className="title-set">光固化</h3>
                                    </div>
