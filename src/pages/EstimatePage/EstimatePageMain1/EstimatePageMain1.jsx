...
function EstimatePageMain1({ toEstimatePageMain2, loginState, orderData, setOrderData, main1ResetKey, setMain1ResetKey,triggerSet,fadeUp}){
    ...
    return(
        <>
            <AnimatePresence>
                <article className="EstimatePageMain1">
