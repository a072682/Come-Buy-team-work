                    ...
                    >
                        <div className="offcanvas-box">
                            ...
                            <div className="offcanvas-body">
                                ...
                                <Nav.Link as={NavLink} to="/EstimatePage" className="offcanvasItem-set" onClick={()=>{handleClose()}}>線上估價</Nav.Link>
                                <Nav.Link as={NavLink} to="/MateriaPage" className="offcanvasItem-set" onClick={()=>{handleClose()}}>材料選擇</Nav.Link>
                                <OffcanvasFaq handleClose={handleClose}/>
                                <Nav.Link as={NavLink} to="/AboutUsPage" className="offcanvasItem-set" onClick={()=>{handleClose()}}>聯絡我們</Nav.Link>
